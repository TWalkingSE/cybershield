...
description: >
  ...
  situação de comprometimento ativo. Situação de emergência — priorize velocidade.
---

# resposta-incidente (wrapper Claude Code)

Wrapper de descoberta para o Claude Code. O conteúdo canônico está em:

**`.github/skills/resposta-incidente/SKILL.md`**
