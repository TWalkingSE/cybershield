...
# analise-ferramenta (wrapper Windsurf)

Wrapper de descoberta para o Cascade. O conteúdo canônico — critérios de
avaliação, alertas conhecidos, formato de saída e regras — está em:

**`.github/skills/analise-ferramenta/SKILL.md`**
