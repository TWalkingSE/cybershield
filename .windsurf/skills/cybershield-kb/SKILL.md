...
# cybershield-kb (wrapper Windsurf)

Este é um **wrapper de descoberta** para o Cascade. O conteúdo canônico deste skill,
incluindo o índice da base de conhecimento e todos os arquivos temáticos em
`references/`, está em:

**`.github/skills/cybershield-kb/SKILL.md`**

Leia o arquivo canônico e os arquivos em `.github/skills/cybershield-kb/references/`
